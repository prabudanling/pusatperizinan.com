...
export const FAQS = [
  ...
  },
  {
    ...
    a: "Tidak perlu. 95% proses kami lakukan secara daring + kurir dokumen ke alamat Anda. Layanan kami menjangkau seluruh 34 provinsi Indonesia. Untuk kebutuhan khusus (audit fisik, AMDAL), tim kami yang akan datang ke lokasi Anda.",
  },
  {
